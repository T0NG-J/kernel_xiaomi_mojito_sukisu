			      ...
			      int flags)
{
	...
	/*
	 * Placed after the IS_ERR() guard: ksu_handle_execveat() dereferences
	 * (*filename_ptr)->name in its CONFIG_KSU_FEATURE_ADBROOT path without
	 * an IS_ERR check of its own.
	 */
#ifdef CONFIG_KSU
